...
export const PRODUCT_CATALOG: CatalogProduct[] = [
  ...
  { slNo: 7, slug: 'k-freight-brake-block', name: 'K-Freight Brake Block', category: 'Braking Products', segment: 'One', image: '/assets/products/placeholder.svg' },
  { slNo: 8, slug: 'k-coaches-bmbs-brake-block', name: 'K-Coaches BMBS Brake Block', category: 'Braking Products', segment: 'One', image: '/assets/products/placeholder.svg' },
  { slNo: 9, slug: 'k-emu-coaches-brake-block', name: 'K-EMU Coaches Brake Block', category: 'Braking Products', segment: 'One', image: '/assets/products/placeholder.svg' },
  { slNo: 10, slug: 'l-freight-coaches-brake-block', name: 'L-Freight Coaches (BLC) Brake Block', category: 'Braking Products', segment: 'One', image: '/assets/products/placeholder.svg' },
  ...
  { slNo: 24, slug: 'iv-coupler', name: 'IV Coupler', category: 'Other Products', segment: 'Four', image: '/assets/products/placeholder.svg' },
