  ...
  return (
    <section id="capabilities" className="section capabilities-section">
      ...
      <div className="container capabilities-inner">
        <div className="capabilities-header fade-in-scroll">
        ...
        <div className="capabilities-cards-grid">
          <div className="capabilities-card fade-in-scroll fade-in-scroll-delay-1">
          ...
          <div className="capabilities-card fade-in-scroll fade-in-scroll-delay-2">
