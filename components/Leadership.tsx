...
export default function Leadership() {
  ...
  const [activeTab, setActiveTab] = useState<'md' | 'director'>('md');
  ...
  return (
    <section ref={sectionRef} className="section leadership-section">
      <div className="container leadership-container">
        <h2 className={`section-title leadership-main-heading fade-in-scroll ${isVisible ? 'is-visible' : ''}`}>
          Management
        </h2>
        ...
        <div className="leadership-tabs">
          <button
            type="button"
            className={`leadership-tab-btn ${activeTab === 'md' ? 'is-active' : ''}`}
          ...
          <button
            type="button"
            className={`leadership-tab-btn ${activeTab === 'director' ? 'is-active' : ''}`}
